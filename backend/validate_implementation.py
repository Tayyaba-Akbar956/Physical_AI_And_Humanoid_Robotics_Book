...
def test_conversation_context():
    ...
    try:
        ...
        message_result = session_manager.add_message_to_session(
...
def test_semantic_search():
    ...
    try:
        ...
        info = search_service.get_collection_stats()
        ...
        try:
            results = asyncio.run(search_service.search("test query", top_k=2))
